...
- (void) tips
{
    UIAlertController* alertController = [UIAlertController alertControllerWithTitle:@"温馨提示" message:@"请先打开手电筒开关" preferredStyle:UIAlertControllerStyleAlert];
...
- (void)viewDidLoad{
    ...
    backgroundImageView.backgroundColor = ViewBackgroundColor;
